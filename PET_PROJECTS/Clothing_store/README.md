...
**Цель:** Выявить лучшую/худшую категорию товаров (ABC-XYZ-анализ), сегментировать клиентскую базу (RFM-анализ). 
...
-	Footwear (A-X) — категория-лидер с высокой ценностью и стабильным спросом, требует поддержания запасов.

...
| -- | ----- | ----- | ----- |
| 1 | [Аналитика факторов ДТП](https://github.com/Zaytsev-V/data-analytics-portfolio/tree/main/PET_PROJECTS/DTP) | Выявление причин тяжести аварий и поведенческих паттернов водителей. Реализован ETL-процесс (API), спроектирована витрина данных в SQL, выявлены скрытые факторы риска. | Python, SQL, API, DataLens |
